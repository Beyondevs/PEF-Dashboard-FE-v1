...
import { Trophy, Medal, Star, Sparkles, Building2 } from 'lucide-react';
...
const Leaderboard = () => {
  ...
  // Report verification summary from school-wise data (totals across filtered schools)
  const schoolSummary = useMemo(() => {
    if (!schoolRows.length) return null;
    const totalStudents = schoolRows.reduce((s, r) => s + (r.totalStudents ?? 0), 0);
    const totalTeachers = schoolRows.reduce((s, r) => s + (r.totalTeachers ?? 0), 0);
    const studentsWithStars = schoolRows.reduce((s, r) => s + (r.studentsWithStars ?? 0), 0);
    const teachersWithStars = schoolRows.reduce((s, r) => s + (r.teachersWithStars ?? 0), 0);
  ...
  const SchoolSummaryCards = ({ summary }: { summary: typeof schoolSummary }) => {
    if (!summary) return null;
    return (
      <TooltipProvider delayDuration={300}>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-8">
          <Tooltip>
                ...
                <CardContent className="pt-6 pb-5">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-2xl font-bold tabular-nums mt-0.5">{summary.totalSchools}</p>
            ...
            <TooltipContent side="bottom" className="max-w-xs">
              <p>Number of schools in the leaderboard (respects division/district/tehsil/school filters).</p>
            </TooltipContent>
          </Tooltip>
          <Tooltip>
            <TooltipTrigger asChild>
              <Card className="transition-shadow hover:shadow-md">
                <CardContent className="pt-6 pb-5">
                  <div className="flex items-center gap-3">
                    <GraduationCap className="h-6 w-6 text-purple-500 shrink-0" />
                    <div className="min-w-0">
                      <p className="text-sm font-medium text-muted-foreground">Total Students</p>
                      <p className="text-2xl font-bold tabular-nums mt-0.5">{summary.totalStudents.toLocaleString()}</p>
            ...
            <TooltipContent side="bottom" className="max-w-xs">
              <p>Sum of students in all schools shown. Use filters to narrow by location.</p>
            </TooltipContent>
          </Tooltip>
          <Tooltip>
            <TooltipTrigger asChild>
                ...
                <CardContent className="pt-6 pb-5">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-2xl font-bold tabular-nums mt-0.5">{summary.totalTeachers.toLocaleString()}</p>
                      <p className="text-xs text-muted-foreground mt-1">Across filtered schools</p>
                    </div>
                  </div>
                </CardContent>
            ...
            <TooltipContent side="bottom" className="max-w-xs">
              <p>Sum of teachers in all schools shown. Use filters to narrow by location.</p>
            </TooltipContent>
          </Tooltip>
          <Tooltip>
            <TooltipTrigger asChild>
              <Card className="transition-shadow hover:shadow-md">
                <CardContent className="pt-6 pb-5">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <p className="text-sm font-medium text-muted-foreground">Total Star Performers</p>
                      <p className="text-2xl font-bold tabular-nums mt-0.5">{summary.totalStarPerformers.toLocaleString()}</p>
                      <p className="text-xs text-muted-foreground mt-1">Students + teachers with stars</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <TooltipContent side="bottom" className="max-w-xs">
              <p>Total number of students and teachers marked as star performers. Compare with report totals.</p>
            </TooltipContent>
          </Tooltip>
          <Tooltip>
            <TooltipTrigger asChild>
                ...
                <CardContent className="pt-6 pb-5">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <p className="text-sm font-medium text-muted-foreground">% Star Performers</p>
                      <p className="text-2xl font-bold tabular-nums mt-0.5 text-amber-700 dark:text-amber-400">
                        {summary.pctStarPerformers.toFixed(1)}%
                      </p>
                      <p className="text-xs text-muted-foreground mt-1">of total students + teachers</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <TooltipContent side="bottom" className="max-w-xs">
              <p>Percentage of all students and teachers who are star performers. Use to verify alignment with report.</p>
            </TooltipContent>
          </Tooltip>
          <Tooltip>
            <TooltipTrigger asChild>
  ...
  const SchoolTable = () => (
    <>
      <SchoolSummaryCards summary={schoolSummary} />
