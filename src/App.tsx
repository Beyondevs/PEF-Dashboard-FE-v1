        ...
        <FilterProvider>
          ...
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/speaking-assessments" element={<ProtectedLayout><PrivateRoute allowedRoles={['admin', 'client', 'teacher', 'bnu']}><SpeakingAssessments /></PrivateRoute></ProtectedLayout>} />
              <Route path="/speaking-assessments/reports" element={<ProtectedLayout><PrivateRoute allowedRoles={['admin', 'client', 'bnu']}><SpeakingAssessmentReports /></PrivateRoute></ProtectedLayout>} />
              <Route path="/leaderboard" element={<ProtectedLayout><PrivateRoute allowedRoles={['admin', 'client', 'teacher', 'bnu']}><Leaderboard /></PrivateRoute></ProtectedLayout>} />
