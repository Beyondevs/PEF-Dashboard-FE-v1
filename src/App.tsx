        ...
        <FilterProvider>
          ...
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/speaking-assessments" element={<ProtectedLayout><PrivateRoute allowedRoles={['admin', 'client', 'teacher', 'division_role', 'bnu']}><SpeakingAssessments /></PrivateRoute></ProtectedLayout>} />
              <Route path="/speaking-assessments/reports" element={<ProtectedLayout><PrivateRoute allowedRoles={['admin', 'client', 'division_role', 'bnu']}><SpeakingAssessmentReports /></PrivateRoute></ProtectedLayout>} />
              <Route path="/leaderboard" element={<ProtectedLayout><PrivateRoute allowedRoles={['admin', 'client', 'teacher', 'division_role', 'bnu']}><Leaderboard /></PrivateRoute></ProtectedLayout>} />
